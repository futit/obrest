...
var OBRest = /** @class */ (function () {
    function OBRest(url, jwtToken) {
        ...
        this.eventCallback = function (status) {
        ...
        this.axios.interceptors.response.use(function (response) { return response; }, function (error) {
            ...
            _this.eventCallback(error);
        });
    }
    /** Create a criteria with the enviroment configuration */
    OBRest.prototype.createCriteria = function (entityName) {
        return new _1.OBCriteria(this.axios, "com.smf.securewebservices.obRest", entityName);
    };
    ...
    OBRest.prototype.setEventCallback = function (callback) {
