            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, OBRest_1.default.getInstance().getAxios().request({
                            ...
                            params: __assign({ sortBy: this._orderBy, firstResult: this._firstResult, maxResults: this._maxResults, q: this._query, identifiers: this._showIdentifiers }, (this._fields.length > 0 ? { fields: this._fields.join(",") } : {}))
                        })];
                    case 1:
                        request = (_a.sent());
